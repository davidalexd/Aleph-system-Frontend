import { CCol, CForm, CFormInput, CFormLabel, CFormTextarea, CModal, CModalBody, CModalHeader, CModalTitle,CModalFooter, CButton, CBadge} from '@coreui/react'
          ...
          <CForm className="row g-2">
            ...
            {reference === 'PERMISO_PERSONAL' && (
              <>
                ...
                <CCol md={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">Autorizado por </CFormLabel>
                </CCol>
                <CCol md={6}>
